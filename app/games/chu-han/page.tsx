...
function settleVictory(game: GameState, actor: Actor): GameState {
...
function resolveAttack(game: GameState, fieldIndex: number, attacker: Actor): GameState {
...
function runAiTurn(game: GameState): GameState {
